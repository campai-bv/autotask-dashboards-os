<?php
	...
	class Dashboardticketstatus extends AutotaskAppModel {

		public $name = 'Dashboardticketstatus';
		...
		public function _findForDashboard( $state, $query, $results = array() ) {
			 ...
			 */
			return Set::extract( $results, '{n}.Dashboardticketstatus.ticketstatus_id' );
