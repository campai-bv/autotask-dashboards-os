...
CREATE TABLE `dashboardqueues` (
  ...
  PRIMARY KEY (`id`),
  KEY `dashboard_x_queue` (`dashboard_id`,`queue_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `dashboardresources` (
  ...
  PRIMARY KEY (`id`),
  KEY `dashboard_x_resource` (`dashboard_id`,`resource_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `dashboards` (
  ...
  `show_tickets_by_issuetype` tinyint(2) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `dashboardticketstatuses` (
  ...
  PRIMARY KEY (`id`),
  KEY `dashboard_x_ticketstatus` (`dashboard_id`,`ticketstatus_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
CREATE TABLE `dashboardwidgets` (
  ...
  `ticketstatus_id` int(10) DEFAULT NULL,
  `type` varchar(255) DEFAULT NULL,
  `col` int(1) DEFAULT NULL,
  `row` int(2) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `dashboard_x_widget` (`dashboard_id`,`widget_id`) USING BTREE
...
CREATE TABLE `dashboardwidgetsettings` (
  ...
  PRIMARY KEY (`id`),
  KEY `dashboardwidget_id` (`dashboardwidget_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `tickets` (
  ...
  PRIMARY KEY (`id`),
  KEY `ticketstatus_id` (`ticketstatus_id`) USING BTREE,
  KEY `queue_id` (`queue_id`) USING BTREE,
  KEY `ticketsource_id` (`ticketsource_id`) USING BTREE,
  KEY `resource_id` (`resource_id`) USING BTREE,
  KEY `account_id` (`account_id`) USING BTREE,
  KEY `issuetype_id` (`issuetype_id`) USING BTREE,
  KEY `subissuetype_id` (`subissuetype_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
...
-- ----------------------------
BEGIN;
INSERT INTO `widgets` VALUES ('1', 'Kill Rate', '3', '1', 'Widgets/kill_rate'), ('2', 'New vs. Closed', '3', '1', 'Widgets/kill_rate_graph'), ('3', 'Average Days Open', '3', '1', 'Widgets/queue_health_graph'), ('4', 'Account Top X', '2', '2', 'Widgets/accounts'), ('5', 'Queue Health', '2', '0', 'Widgets/queues'), ('6', 'Resources', '2', '0', 'Widgets/resources'), ('7', 'Ticket Status', '1', '1', 'Widgets/ticketstatus'), ('8', 'New vs. Closed', '3', '1', 'Widgets/kill_rate_bars'), ('9', 'Latest tickets', '3', '2', 'Widgets/tickets_top_x'), ('10', 'Clock', '1', '1', 'Widgets/clock'), ('11', 'Open', '1', '1', 'Widgets/opentickets'), ('12', 'Tickets by source', '3', '2', 'Widgets/tickets_by_source'), ('13', 'Tickets by Issue type', '3', '2', 'Widgets/tickets_by_issuetype');
COMMIT;
